...
namespace AumTechnolabs\MyWishlistWithSwatches\Model;
    ...
    public function moveAllToCart(Wishlist $wishlist, $qtys)
    {
        ...
        foreach ($collection as $item) {
            ...
            try {
                ...
                // Custom Code To Put Super Attributes While Adding All To Cart
                $originalBuyRequest = $item->getBuyRequest();
                try {
                    $requestSuperAttributes = $this->request->getParam('super_attribute');
                    $itemSuperAttributes = $item->getBuyRequest()->getSuperAttribute();
                    foreach ($requestSuperAttributes as $superAttributeId => $superAttributeValueItemIdWise) {
                        $itemSuperAttributes[$superAttributeId] = $superAttributeValueItemIdWise[$item->getId()];
                    }
                    $buyRequest = $item->getBuyRequest();
                    $buyRequest->setSuperAttribute($itemSuperAttributes);
                    $item->mergeBuyRequest($buyRequest);
                } catch (\Exception $e) {
                    $item->mergeBuyRequest($originalBuyRequest);
                }
                // Custom Code Ends.
